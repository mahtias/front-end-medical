...
$(document).ready(function () {
    ...
    if ($(".noti-body")[0]) {
        var b = new PerfectScrollbar(".notification  .noti-body", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40 });
    }
    if (!$(".pcoded-navbar").hasClass("theme-horizontal")) {
        var c = $(window)[0].innerWidth;
        if ($(".navbar-content")[0]) {
            if (c < 992 || $(".pcoded-navbar").hasClass("menupos-static")) {
                var b = new PerfectScrollbar(".navbar-content", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40 });
            } else {
                var b = new PerfectScrollbar(".navbar-content", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40 });
            }
        }
    ...
    $(".card-option .close-card").on("click", function () {
        var d = $(this);
        d.parents(".card").addClass("anim-close-card");
        d.parents(".card").animate({ "margin-bottom": "0" });
        setTimeout(function () {
            d.parents(".card").children(".card-block").slideToggle();
            d.parents(".card").children(".card-body").slideToggle();
            d.parents(".card").children(".card-header").slideToggle();
            d.parents(".card").children(".card-footer").slideToggle();
        }, 600);
        setTimeout(function () {
            d.parents(".card").remove();
        }, 1500);
    });
    ...
    $(".card-option .minimize-card").on("click", function () {
        var f = $(this);
        var d = $(f.parents(".card"));
        var e = $(d).children(".card-block").slideToggle();
        var e = $(d).children(".card-body").slideToggle();
    ...
    $(".card-option .full-card").on("click", function () {
        var i = $(this);
        var e = $(i.parents(".card"));
        e.toggleClass("full-card");
        $(this).children("a").children("span").toggle();
        if (e.hasClass("full-card")) {
            ...
            var h = $(window).height();
            var f = $(window).width();
            e.animate({ marginLeft: d - d * 2, marginTop: g - g * 2, width: f, height: h });
        } else {
            $("body").css("overflow", "");
            e.removeAttr("style");
            setTimeout(function () {
                $("html,body").animate({ scrollTop: $(e).offset().top - 70 }, 500);
            }, 400);
        }
    });
